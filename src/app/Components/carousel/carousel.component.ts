...
export class CarouselComponent {
  constructor(private sharedService: SharedService, private goodsData:GoodsDataService) {}
  products = new Map();
  ...
  removeAllDuplicates(){
    ...
    this.goods = data;
     ...
     for (let i = 0; i < this.goods.length; i++) {
      let finObj = this.products3.get(this.goods[i].groupName + " " + this.goods[i].groupCode);
    ...
    this.products3.set(this.goods[i].groupName + " " + this.goods[i].groupCode,[obj]);
  }
